...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        void DrawCustomModulesTab()
        {
            ...
            if (ADClipSettings_CustomModules.CopyingFrom != null)
            {
                ...
                {
                    ADClipSettings_CustomModules.PasteValuesTo(ADClipSettings_CustomModules.CopyingFrom, cModule);
                }
            }

            if (ADClipSettings_CustomModules.CopyingFrom == cModule) GUI.backgroundColor = new Color(0.6f, 1f, 0.6f, 1f);
            if (GUILayout.Button(new GUIContent(EditorGUIUtility.IconContent("TreeEditor.Duplicate").image, "Copy Modifiers parameters values below to paste them into other limb"), FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(19)))
            {
                ADClipSettings_CustomModules.CopyingFrom = cModule;
            }
            if (ADClipSettings_CustomModules.CopyingFrom == cModule) GUI.backgroundColor = preBG;
