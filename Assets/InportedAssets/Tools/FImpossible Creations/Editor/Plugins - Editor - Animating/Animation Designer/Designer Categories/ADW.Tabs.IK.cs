...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        void DrawIKTab()
        {
            ...
            GUILayout.Space(5);
            if (GUILayout.Button(new GUIContent(EditorGUIUtility.IconContent("TreeEditor.Duplicate").image, "Copy IK parameters values from all limbs below to paste them into other animation clip limbs settings"), FGUI_Resources.ButtonStyle, GUILayout.Width(22), GUILayout.Height(19)))
            {
