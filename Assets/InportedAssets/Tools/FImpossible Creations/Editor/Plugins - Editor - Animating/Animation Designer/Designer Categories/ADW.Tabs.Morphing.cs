...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        void DrawMorphingTab()
        {
            ...
            if (ADClipSettings_Morphing.CopyingFrom != null)
            {
                ...
                {
                    ADClipSettings_Morphing.PasteValuesTo(ADClipSettings_Morphing.CopyingFrom, setup);
                }
            }

            if (ADClipSettings_Morphing.CopyingFrom == setup) GUI.backgroundColor = new Color(0.6f, 1f, 0.6f, 1f);
            ...
            {
                ADClipSettings_Morphing.CopyingFrom = setup;
            }
            if (ADClipSettings_Morphing.CopyingFrom == setup) GUI.backgroundColor = preBG;
