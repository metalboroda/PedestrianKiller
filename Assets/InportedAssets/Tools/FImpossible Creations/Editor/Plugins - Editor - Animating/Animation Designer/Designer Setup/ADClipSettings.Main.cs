...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADClipSettings_Main : IADSettings
    {
        ...
        /// <summary> Not used anymore - left here for back version compability </summary>
        public bool Additional_UseHumanoidMecanimIK = true;


        public enum EAnimationSamplingMode { SampleAnimationClip, Mecanim, Playable }
        public EAnimationSamplingMode Additional_AnimationSampling = EAnimationSamplingMode.Mecanim;
        [Tooltip( "Used as temporary solution for playable sampling, which can be helpful for world IK points maintaining" )]
        public bool ResetPositionOnReplay = false;

        /// <summary> Shortcut to get Additional_AnimationSampling value </summary>
        public EAnimationSamplingMode AnimationSamplingMode { get { return Additional_AnimationSampling; } }
        ...
        public ADClipSettings_Main Copy(ADClipSettings_Main to, bool noCopy)
        {
            ...
            cpy.Additional_AnimationSampling = Additional_AnimationSampling;
        ...
        public void ApplySettingsOf( ADClipSettings_Main from )
        {
            ...
            Additional_AnimationSampling = from.Additional_AnimationSampling;
        ...
        internal void LateUpdateSimulation(float dt, float elasticDt, float progr, AnimationDesignerSave save)
        {
            ...
            if (AnimationSamplingMode == EAnimationSamplingMode.Playable && AnimationDesignerWindow.isCalmingModel) return;
